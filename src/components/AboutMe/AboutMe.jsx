    ...
    <section className='about-me' id='student'>
      ...
      <div className='about-me__text-container'>
        ...
        <div className='about-me__links-container'>
            <a className='about-me__link' href='https://www.facebook.com/karina.maulitova'>Facebook</a>
            <a className='about-me__link' href='https://github.com/karinamaulitova'>Github</a>
        </div>
      </div>
